function inversion() {
    ...
    switch (campoTiempo) {
        ...
        case "4":
            ganancia = (campoInversion * 2.1)/100 * 12;
            gananciaTotal = parseInt(campoInversion) + parseInt(ganancia);

            totalShow.innerText = ganancia;
            gananciaTotalShow.innerText = gananciaTotal;
            tiempoShow.innerText = "48 meses ";
            interesShow.innerText = "2.1% ";
            break; 


        case "5":
            ganancia = (campoInversion * 2.4)/100 * 12;
            gananciaTotal = parseInt(campoInversion) + parseInt(ganancia);

            totalShow.innerText = ganancia;
            gananciaTotalShow.innerText = gananciaTotal;
            tiempoShow.innerText = "60 meses ";
            interesShow.innerText = "2.4% ";
            break; 

        case "6":
            ganancia = (campoInversion * 2.8)/100 * 12;
            gananciaTotal = parseInt(campoInversion) + parseInt(ganancia);

            totalShow.innerText = ganancia;
            gananciaTotalShow.innerText = gananciaTotal;
            tiempoShow.innerText = "72 meses ";
            interesShow.innerText = "2.8% "; 
            break;
    }
}